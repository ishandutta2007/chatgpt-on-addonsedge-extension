    ...
    <div className="container mx-auto">
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">AddonsedgeGPT(v{getExtensionVersion()})</span>
        </div>
        <div className="flex flex-row gap-3">
          ...
          <a
            href="https://github.com/SingularityLabs-ai/chatgpt-on-addonsedge-extension/issues"
            target="_blank"
            rel="noreferrer"
          >
            Feedback
          ...
          <a
            href="https://github.com/SingularityLabs-ai/chatgpt-on-addonsedge-extension"
            target="_blank"
            rel="noreferrer"
          >
            Source code
